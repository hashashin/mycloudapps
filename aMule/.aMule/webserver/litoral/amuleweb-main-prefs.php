...
//		)
	var check_param_names = new Array(
		"autoconn_en", "udp_dis", "new_files_paused",
		"check_free_space","new_files_auto_dl_prio"
		)
  ...
  <tr valign="top"> 
    ...
    <td width="100%" height="64" align="right" background="images/fond_haut.png"> <table border="0" cellspacing="0" cellpadding="0">
        <tr> 
          ...
          <td width="10"></td>
          <td width="190" align="right" class="texteinv"><a href='javascript:location.replace("http://"+document.domain)'>exit</a><br>
      ...
      <td> 
        <table width="350" border="0" align="center" cellpadding="0" cellspacing="0" >
          <tr> 
            ...
            <td height="25">Page refresh interval (seconds)</td>
